...
pygame.display.set_caption("Aim Trainer Initial")
...
def end_screen(win, elapsed_time, target_pressed, clicks):
    ...
    win.blit(speed_label, (get_middle(time_label),150))
    win.blit(hits_label, (get_middle(time_label),250))
...
def main():
    ...
    while running:
        ...
        for target in targets: 
            ...
            if click and target.colllide(* mouse_pos):
                targets.remove(target)
                target_pressed += 1
